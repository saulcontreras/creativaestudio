  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="absolute right-full mr-4 bg-white text-text-dark px-3 py-1 rounded-lg text-xs font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity shadow-sm pointer-events-none">
          ¡Vení a jugar!
        </div>
      </a>
    </div>
